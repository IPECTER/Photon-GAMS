...
const vec3[64] light_color = vec3[64](
	...
	vec3(0.75, 1.00, 0.83) * vec3(0.75, 1.00, 0.83) * 1.5, // Sculk
	vec3(0.75, 1.00, 0.83) * vec3(0.75, 1.00, 0.83) * 1.0, // End portal frame
	...
	vec3(0.0),  // End portal
	vec3(1.0, 0.1, 0.1) * vec3(1.0, 0.1, 0.1) *  8.0, // Red
	vec3(1.0, 0.5, 0.1) * vec3(1.0, 0.5, 0.1) *  8.0, // Orange
	vec3(1.0, 1.0, 0.1) * vec3(1.0, 1.0, 0.1) * 8.0, // Yellow
	vec3(0.7, 0.7, 0.0) * vec3(0.7, 0.7, 0.0) *  8.0, // Brown
	vec3(0.1, 1.0, 0.1) * vec3(0.1, 1.0, 0.1) * 8.0, // Green
	vec3(0.5, 1.0, 0.5) * vec3(0.5, 1.0, 0.5) * 8.0, // Lime
	vec3(0.1, 0.1, 1.0) * vec3(0.1, 0.1, 1.0) * 8.0, // Blue
	vec3(0.5, 0.5, 1.0) * vec3(0.5, 0.5, 1.0) * 8.0, // Light blue
	vec3(0.1, 1.0, 1.0) * vec3(0.1, 1.0, 1.0) * 8.0, // Cyan
	vec3(0.7, 0.1, 1.0) * vec3(0.7, 0.1, 1.0) * 8.0, // Purple
	vec3(1.0, 0.1, 1.0) * vec3(1.0, 0.1, 1.0) * 8.0, // Magenta
	vec3(1.0, 0.5, 1.0) * vec3(1.0, 0.5, 1.0) * 8.0, // Pink
	vec3(0.1, 0.1, 0.1) * vec3(0.1, 0.1, 0.1) * 8.0, // Black
	vec3(0.9, 0.9, 0.9) * vec3(0.9, 0.9, 0.9) * 8.0, // White
	vec3(0.3, 0.3, 0.3) * vec3(0.3, 0.3, 0.3) * 8.0, // Gray
	vec3(0.7, 0.7, 0.7) * vec3(0.7, 0.7, 0.7) * 8.0,  // Light gray
