...
const vec3[64] light_color = vec3[64](
	...
	vec3(1.00, 0.57, 0.30) * vec3(1.00, 0.57, 0.30) * 12.0, // Strong golden light (Jack o' Lantern)
	...
	vec3(0.60, 0.10, 1.00) * vec3(0.60, 0.10, 1.00) * 5.0, // Purple glow
	...
	vec3(1.0, 0.75, 0.15) * vec3(1.0, 0.75, 0.15) * 1.0, // Yellow
